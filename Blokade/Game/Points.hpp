...
public:
   ...
   // void setTopScore(const int id_topScore);
    ...
    //
    //----------------------------------------------------------------------*
    //void setTopLines(const int id_topLines);
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getPointsAsString();
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getTopPointsAsString();
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getLinesAsString();
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getTopLinesAsString();
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getBlocksAsString();
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getLevelAsString();
    ...
    //&---------------------------------------------------------------------*
    //&      Method  getTopScoreBeaten
    //&---------------------------------------------------------------------*
    //
    //----------------------------------------------------------------------*
    const bool getLowestTopScoreBeaten();
    
    //&---------------------------------------------------------------------*
    //&      Method  getTopLinesBeaten
    //&---------------------------------------------------------------------*
    //
    //----------------------------------------------------------------------*
    const bool getLowestTopLinesBeaten();
    ...
    //
    //----------------------------------------------------------------------*
    void setSettings(FileAccess::Data* id_pSettings);
    ...
    //
    //----------------------------------------------------------------------*
    void resortTopScores(const std::string id_name);
    ...
    //
    //----------------------------------------------------------------------*
    const std::string getIntAsString(int id_int);
...
private:
    ...
    int m_points = 0;
    int m_topPoints = 0;
    int m_lowestPointsToBeat = 0;
    int m_topLines = 0;
    int m_lowestLinesToBeat = 0;
    int m_digits = 9;
    int m_lines = 0;
    int m_blocks = 0;
    int m_level = 0;
    ...
    bool m_lowestTopScoreBeaten = false;
    bool m_lowestTopLinesBeaten = false;

    std::vector<GFXBean> m_levelBeans;

    FileAccess::Data* m_pSettings = NULL;
