...
public:
    ...
    //
    //----------------------------------------------------------------------*
    virtual const std::string getInputValue() { return std::string(""); }
    ...
    //
    //----------------------------------------------------------------------*
    virtual void setInputValue(const std::string id_value) {}
    ...
    //
    //----------------------------------------------------------------------*
    virtual const bool getInputFinished() { return false; }
